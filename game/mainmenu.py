...
class MainMenu(View):
    ...
    def setup(self):
        ...
        self.background = load_texture(f"{RESOURCE_PATH}backgrounds/TitleScreen.png")

        textureLearn = load_texture(f"{RESOURCE_PATH}buttons/LearnButton.png")
        textureLearnHovered = load_texture(f"{RESOURCE_PATH}buttons/LearnButtonHovered.png")
        textureGame = load_texture(f"{RESOURCE_PATH}buttons/GameButton.png")
        textureGameHovered = load_texture(f"{RESOURCE_PATH}buttons/GameButtonHovered.png")
        textureScores = load_texture(f"{RESOURCE_PATH}buttons/ScoresButton.png")
        textureScoresHovered = load_texture(f"{RESOURCE_PATH}buttons/ScoresButtonHovered.png")
        textureInstructions = load_texture(f"{RESOURCE_PATH}buttons/InstructionsButton.png")
        textureInstructionsHovered = load_texture(f"{RESOURCE_PATH}buttons/InstructionsButtonHovered.png")
        textureQuit = load_texture(f"{RESOURCE_PATH}buttons/QuitButton.png")
        textureQuitHovered = load_texture(f"{RESOURCE_PATH}buttons/QuitButtonHovered.png")
